	...
	<body>
		<header>
			...
			<div class="right-section">
				<a href="./indexManager.php" class="pagrindinis">
			...
			<div class="ataskaita">
				...
				<div class="prisijungimai_intervale"style="margin-top:20px;">
					...
					//if ($_POST != null ) 
					{
						...
						$sql = "SELECT `id`,`naudotojo_id`,`data`, `statusas` FROM `Mokejimai` WHERE `data` > '$from_time' AND `data` <
						'$to_time'";
						...
						if(mysqli_num_rows($result)>0){
							...
							echo "<p style='color:red; font-weight:bold;'>Pasirinktame laiko intervale mokėjimų nėra.</p>";
						}
