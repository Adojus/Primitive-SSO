	...
	<body>
		<header>
			...
			<div class="right-section">
				<a href="./indexAdmin.php" class="pagrindinis">
		...
		<div class="ataskaita">
			...
			<div class="ataskaita">
				<h2>Naudotojų prisijungimai prie sistemos laiko intervale</h2>
				<form method="post">
					<div style="margin-top:10px;">
					<label for="from_time">Pasirinkite laiką nuo (formatu metai-mėnuo-diena val:min): </label>
					<br>
					<input class="date-picker" type="datetime-local" id="from_time" name="from_time" required>
					</div>
					<div style="margin-top:15px;">
					<label for="to_time" >Pasirinkite laiką iki (formatu metai-mėnuo-diena val:min): </label>
					<br>
				...
				<div class="prisijungimai_intervale"style="margin-top:20px;">
					...
					//if ($_POST != null ) 
					{
						...
						$sql = "SELECT `naudotojo_id`,`laikas`, `ip_adresas` FROM `Prisijungimai` WHERE `laikas` > '$from_time' AND `laikas` <
						'$to_time'";
						...
						if(mysqli_num_rows($result)>0){
							...
							echo "<p style='color:red; font-weight:bold;'>Pasirinktame laiko intervale prisijungimų nėra.</p>";
						}
